...
public class BenhNhan {
	...
	@ManyToOne
    @JoinColumn(name = "cmnd_ConNguoi",  nullable = true)
    private ConNguoi cmnd_BenhNhan;
	
	@ManyToOne
    @JoinColumn(name = "maCSYT",  nullable = true)
    private CoSoYTe maCSYT_BenhNhan;
	
	@Column(name = "TT",  nullable = true)	
    private String trangThai;

	public BenhNhan(int maBN, String ngayPhatHien, int soMuiVacin, int soLanMac, ConNguoi cmnd_BenhNhan, CoSoYTe maCSYT_BenhNhan, String trangThai) {
		super();
		this.maBN = maBN;
